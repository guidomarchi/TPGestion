...
IF OBJECT_ID('4_FILAS_AFECTADAS.TipoMedioDePago', 'U') IS NOT NULL DROP TABLE [4_FILAS_AFECTADAS].TipoMedioDePago;
...
--------------------------------------------------------------/PROCEDURES/------------------------------------------------------------
CREATE PROCEDURE [4_FILAS_AFECTADAS].CARGAR_TABLAS
AS
BEGIN
print 'Tabla Modelo'
...
---------------------------------------------------------/EJECUTAR PROCEDURES/--------------------------------------------------------
BEGIN TRANSACTION
	EXEC [4_FILAS_AFECTADAS].CARGAR_TABLAS
COMMIT TRANSACTION
